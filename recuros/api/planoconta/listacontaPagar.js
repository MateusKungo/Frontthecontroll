...
//alert("Carregando lista de contas a pagar..."); // Mensagem para indicar que o script foi carregado
async function fetchContasFromAPI() {
    try {
        ...
        const contasFiltradas = contas.filter(conta => conta.tipo === "Saídas" && conta.status !== "Desativa");
