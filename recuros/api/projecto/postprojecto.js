...
document.getElementById('userFormPost').addEventListener('submit', async function(event) {
    ...
    formData.append('nomeProjecto', document.getElementById('nomeProjecto').value);
    formData.append('descricaoProjecto', document.getElementById('descricaoProjecto').value);
